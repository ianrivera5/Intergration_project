...
# My program is based on my current job as a tennis instructor/court maintenance to help me manage my work and keep track of my supplies.
# Hackerrank.com was used as source.
# Introduction/Greetings
print("Hello Everyone!")
print("Welcome to my Integration Project!")
print("This is to", end=' ')
print("keep track of my work.", end='\n')
# Name of company I work for
print("@BlackWoodTennis", end='\n')
print("My weekly court grooming tasks")
# There are five courts that need maintenance five days a week, this determines how much is done in a month
print(5 * 5)
...
print(110 - 10 * 5)
# The remaining net holders are divided by 5 to determine how much each court gets the leftovers
print(60 / 5)
# The 12 net holders in each court are divided to see how many remain in each court
print(12 // 5)
# The remaining 2 net holders in each court by 5
print(5 % 2)
# An important reminder that sometimes is forgotten
print("Remember" + " " + "to" + " " + "check" + " " + "the" + " " + "windscreens" + '.')
...
# Helps me determine how many gallons of gas are left in container used for golf cart/Enter #5
...
bags += outside_bags
print(bags)
# tells me that there is 5 tennis courts and only 2 pickle ball courts, not the same amount
tennis_court = 5
pickle_ball = 2
...
# If the gas container has 5 gallons it is good, if not, I must call my boss for more
gas_container = 5
call = 1
...
# numbers represent the daily tasks I have to do, number of tasks depends on size of location, if less than 10, day off
...
# One location that I work only has 3 courts and the other location only has five
hammock_bay = 3
reserve = 5
...
# This tells me how many times I go to Naples Reserve/Hammock Bay location in a week
reserve = 0
while reserve < 3:
...
# The tennis courts that lessons are done on
def tennis(teaching=2):
    print(f'Tennis Court {teaching}')


tennis(5)  # function parameter is passed
tennis()
